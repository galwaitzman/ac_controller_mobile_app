...
The controller's MQTT client is constantly waiting for incmoing commands. Once a command arrives, it is executed using the IR-transmitting circuit, and a confirmation message is sent on the relevant status topic (power / temperature / fan).
